      ...
      <div className="bg-white rounded-lg border-2 border-[#e2e8f0] p-6 space-y-6">
        <div className="space-y-4">
          <Input
            ...
            placeholder="Orijinal fiyatı girin (örn: 100)"
            error={originalPriceError || undefined}
            helperText="İndirim öncesi orijinal fiyatı girin"
            step="0.01"
            min="0.01"
          />
          <Input
            ...
            placeholder="İndirim yüzdesini girin (örn: 20)"
            error={discountPercentageError || undefined}
            helperText="İndirim yüzdesini girin (0-100)"
            step="0.1"
            min="0"
            max="100"
          />
