    ...
    <div className="min-h-screen bg-[#f8fafc] dark:bg-[#020617]">
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold text-[#1e293b] dark:text-[#f1f5f9] mb-6">
            Calculator360Pro
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {categories.map((category) => {
            ...
            return (
              <div
                key={category.slug}
                className="bg-white dark:bg-[#1e293b] rounded-lg border-2 border-[#e2e8f0] dark:border-[#334155] p-6"
              >
        ...
        <div className="bg-white dark:bg-[#1e293b] rounded-lg border-2 border-[#e2e8f0] dark:border-[#334155] p-8 mb-16">
          <h2 className="text-3xl font-bold text-[#1e293b] dark:text-[#f1f5f9] mb-6">
            Popular Calculators
          </h2>
        ...
        <article className="bg-white dark:bg-[#1e293b] rounded-lg border-2 border-[#e2e8f0] dark:border-[#334155] p-8">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <h3 className="text-2xl font-bold text-[#1e293b] dark:text-[#f1f5f9] mt-8 mb-4">
