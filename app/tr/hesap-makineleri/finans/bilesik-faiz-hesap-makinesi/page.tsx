...
export const metadata: Metadata = {
  ...
  description: "Bileşik faiz hesap makinesi 2026: Ana para, faiz oranı ve vade ile birikim ve yatırım getirinizi anında hesaplayın. Ücretsiz bileşik faiz hesaplama - hemen deneyin.",
  keywords: [
